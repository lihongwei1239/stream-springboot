package com.stream.streamspringbootmybatisannotationmulidatasource.datasource;
...
@Configuration
@MapperScan(
        basePackages = "com.stream.streamspringbootmybatisannotationmulidatasource.mapper.secondary",
