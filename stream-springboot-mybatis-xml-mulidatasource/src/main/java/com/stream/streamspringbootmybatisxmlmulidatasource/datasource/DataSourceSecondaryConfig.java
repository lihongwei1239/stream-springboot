package com.stream.streamspringbootmybatisxmlmulidatasource.datasource;
...
@Configuration
@MapperScan(
        basePackages = "com.stream.streamspringbootmybatisxmlmulidatasource.mapper.secondary",
